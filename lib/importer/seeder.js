...
async function insertData(client, data, tableSuffix = '') {
  const filmSql = `insert into filmsonfreeview.film${tableSuffix}(name, year, synopsis, tmdb_id, tmdb_rating) values($1, $2, $3, $4, $5) returning id`;
  const showtimeSql = `insert into filmsonfreeview.showtime${tableSuffix}(starts_at, ends_at, channel, film_id) values($1, $2, $3, $4)`;
